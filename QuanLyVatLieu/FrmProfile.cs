...
namespace QuanLyVatLieu
{
    ...
    public partial class FrmProfile : Form
    {
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                NVBLL.CapNhat(nv.MaNV, txtTenNV.Text, txtChucVu.Text, dtpNgaySinh.Value, int.Parse(cbbGioitinh.SelectedValue.ToString()), txtSodienthoai.Text, txtTendangnhap.Text, txtEmail.Text);
